...
export function Subscription() {
      ...
      const fetchUserDetails = async () => {
        try {
          ...
          const config = {
            ...
            url: `http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8081/api/user/search/${storedUser.id}`,
            headers: {
      ...
      const fetchSubscriptions = async () => {
        try {
          const config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: `http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8080/api/subscription/search-subscription-with-course-by-user/${storedUser.id}`,
            headers: {}
          };
  ...
  const handleSave = async (subscription: Subscription) => {
    ...
    try {
      ...
      const config = {
        method: 'put',
        maxBodyLength: Infinity,
        url: 'http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8082/api/subscription/update',
        headers: {
  ...
  const handleDelete = async (subscriptionId: number) => {
    try {
      await axios.delete(`http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8082/api/subscription/delete/${subscriptionId}`, {
        headers: {}
      });
