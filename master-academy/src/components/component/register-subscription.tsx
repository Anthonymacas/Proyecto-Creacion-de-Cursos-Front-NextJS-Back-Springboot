...
export function RegisterSubscription() {
  ...
  useEffect(() => {
    if (storedUser) {
      ...
      const fetchCourses = async () => {
        try {
          const response = await axios.get('http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8080/api/course/all');
  ...
  const handleGuardarSubs = async (event: FormEvent) => {
    ...
    const config = {
      ...
      url: "http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8082/api/subscription/create",
      headers: {
