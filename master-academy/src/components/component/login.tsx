...
export function Login() {
  ...
  const handleLogin = async (event: FormEvent) => {
    ...
    try {
      const response = await axios.post('http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8081/api/user/login', data, {
        headers: {
      ...
      const userResponse = await axios.get(`http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8081/api/user/search-by-email/${email}`, {
        headers: {
