...
export function Administrator() {
      ...
      const fetchUsers = async () => {
        try {
          let config = {
            ...
            url: 'http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8081/api/user/all',
            headers: {
  ...
  const handleSave = async (user: User) => {
    ...
    const config = {
      method: 'put',
      maxBodyLength: Infinity,
      url: 'http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8081/api/user/update',
      headers: {
  ...
  const handleDelete = async (userId: number) => {
    ...
    try {
      await axios.delete(`http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8081/api/user/delete/${userId}`, {
        headers: {
          'Authorization': `Bearer ${storedUser.token}`
        }
      });
