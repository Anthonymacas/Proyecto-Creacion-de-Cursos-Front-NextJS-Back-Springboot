...
export function Course() {
      ...
      const fetchCourses = async () => {
        try {
          const config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: `http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8080/api/course/searchCourses-by-user/${storedUser.id}`,
            headers: {}
          };
  ...
  const handleSave = async (course: Course) => {
    ...
    const config = {
      method: 'put',
      maxBodyLength: Infinity,
      url: 'http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8083/api/course/update',
      headers: {
  ...
  const handleDelete = async (courseId: number) => {
    try {
      await axios.delete(`http://ec2-3-141-15-150.us-east-2.compute.amazonaws.com:8083/api/course/delete/${courseId}`, {
        headers: {}
      });
